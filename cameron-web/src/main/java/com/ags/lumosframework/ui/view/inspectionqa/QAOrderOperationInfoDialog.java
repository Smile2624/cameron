...
@SpringComponent
@Scope("prototype")
public class QAOrderOperationInfoDialog extends BaseDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4418680259683613331L;
	...
	protected Component getDialogContent() {
		VerticalLayout vlContent = new VerticalLayout();
	       vlContent.setSizeFull();
			...
			taOperationAttention.addStyleName(ValoTheme.LABEL_H4);
			taOperationAttention.setEnabled(false);
			taOperationAttention.setHeight("50%");
