...
@SpringComponent
@Scope("prototype")
public class DimensionInspectionDialog extends BaseDialog {
	
	private static final long serialVersionUID = 8584113202077829268L;
					...
					if(dimensionInspectionResultList!=null && dimensionInspectionResultList.size()>0) {
						for(DimensionInspectionResult dimensionInspectionResult : dimensionInspectionResultList) {
							if(dimensionInspectionResult!=null) {
								...
								dimensionInspectionDialogResult.setInspectionItem(dimensionInspectionResult.getInspectionName());
...
//        hlLayout.addComponent(btnNext);
        ...
        grid.addColumn(DimensionInspectionDialogResult::getInspectionItem).setCaption(I18NUtility.getValue("DimensionInspectionDialog.inspectionItem", "InspectionItem"));
