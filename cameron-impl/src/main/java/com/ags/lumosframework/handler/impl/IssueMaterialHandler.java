...
import com.ags.lumosframework.dao.IssueMaterialDao;
...
@Service
@Primary
public class IssueMaterialHandler extends AbstractBaseEntityHandler<IssueMaterialListEntity> implements IIssueMaterialHandler {

    private static final long serialVersionUID = -6901264602022745947L;

    @Autowired
    private IssueMaterialDao issueMaterialDao;

    @Override
    protected BaseEntityDao<IssueMaterialListEntity> getDao() {
        return issueMaterialDao;
    }
}
